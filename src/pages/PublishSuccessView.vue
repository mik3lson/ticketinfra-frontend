...
const checkoutUrl = computed(() => `https://checkout.ticketinfra.africa/c/${code.value}`)
...
const sdkEmbed = `ticketInfra.openCheckout("${code.value}")`
</script>
...
<template>
  <div class="space-y-6 py-6">
    <PageHeader
      ...
      subtitle="Share the live checkout URL, connect the API endpoint, or embed ticketInfra into any website."
    />
    ...
    <div class="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
      ...
      <aside class="gatepass-card rounded-[32px] p-6">
        <div class="rounded-[28px] bg-gradient-to-br from-[#111111] via-[#17191f] to-[#f05537] p-6 text-white">
          ...
          <div class="mt-3 text-3xl font-semibold tracking-tight">ticketInfra</div>
